      ...
      <Wrapper>
          ...
          <div className="container">
            ...
            <div className="p-2">
              <p>
                ...
                is the best ghewar available in Delhi... being a big ghewar fan
                I want it to be crispy and creamy at the same time and this
                place took my heart after I ate this. I had no idea that they
                served the best but trust me try it for once and you will lick
                your fingers once the box is over.
              </p>
              <div>
                <img
        ...
        <footer className="main-footer bg-light">
          ...
          <p className="policy container">
            ...
            are properties of their respective owners. 2008-2020 © EatHub™ Pvt
