...
export const queryCity = (city) => {
  return (dispatch) => {
    ...
    return axios({
      ...
      params: {
        access_token:
          "pk.eyJ1Ijoidm9sZGxhIiwiYSI6ImNrcTYyeDRnaDFueDUyb3A4ajgwajExZHgifQ.S_AnR85C9xrHAlwTt71rHA",
        country: "IN",
      },
    })
      .then((response) => {
...
export const queryRestaurant = (query, cityId) => {
  return (dispatch) => {
    ...
    return axios({
      method: "get",
        url: `${process.env.REACT_APP_BACKEND_URL}/api/search/restaurant`,
      params: {
        q: query,
        city_id: cityId,
      },
...
export const userSignupVerify = (payload) => {
  return (dispatch) => {
    ...
    return axios({
      method: "post",
        url: `${process.env.REACT_APP_BACKEND_URL}/api/auth/verifyRegister`,
      data: payload,
    })
      .then((response) => {
...
export const userLoginVerify = (payload) => {
  return (dispatch) => {
    ...
    return axios({
      method: "post",
        url: `${process.env.REACT_APP_BACKEND_URL}/api/auth/verifyLogin`,
      data: payload,
    })
      .then((response) => {
...
export const getCityId = (payload) => {
  return (dispatch) => {
    ...
    return axios({
      method: "post",
        url: `${process.env.REACT_APP_BACKEND_URL}/api/search/cityId`,
      data: payload,
      headers: {
...
export const getCityCollection = (cityId) => {
  return (dispatch) => {
    ...
    return axios({
      method: "post",
        url: `${process.env.REACT_APP_BACKEND_URL}/api/search/collection`,
      data: { city_id: cityId },
    })
      .then((response) => {
